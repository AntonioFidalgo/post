...
tags: ["data", "data set", "ols", "wage estimation"]
categories: ["ols"]
link-citations: true
ShowToc: true
editPost:
...
Our sample contains a very large number of observations, more than 4mio, for a selection of variables from the above data set. It is available in `.dta` format [here.](sampleqp.dta)  
